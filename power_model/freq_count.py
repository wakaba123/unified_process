...
for i in range(8):
    cpu_freq_data_temp = cpu_freq_data[cpu_freq_data['cpu'] == i]
    cpu_idle_data_temp = cpu_idle_data[cpu_idle_data['cpu'] == i]
    ...
    for frequency in frequencies:
        filtered_cpu_freq_data = cpu_freq_data_temp[cpu_freq_data['value'] == frequency]
    ...
    for frequency in frequencies:
        ...
        for index, row in filtered_cpu_freq_data.iterrows():
            ...
            for _,temp in cpu_idle_data.iterrows():
                state_start = temp['start']
                state_end = temp['end'] 
                state = temp['value']
